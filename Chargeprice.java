...
public class Chargeprice extends AppCompatActivity {

    TextView t1,t2;
    String val1,type="Charge";
    Button Pay;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chargeprice);
        ...
        Pay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Chargeprice.this,CustomerDetails.class);
