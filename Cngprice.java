...
public class Cngprice extends AppCompatActivity {

    TextView t1,t2;
    String val1,type="CNG";
    Button Pay;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cngprice);
        ...
        Pay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Cngprice.this,CustomerDetails.class);
