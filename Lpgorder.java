...
public class Lpgorder extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lpgorder);
        ...
        btproceed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(val)){
                    Toast.makeText(Lpgorder.this,"Enter Amount of Fuel",Toast.LENGTH_SHORT).show();
                    return;
                }else {

                    Intent intent = new Intent(Lpgorder.this, Lpgprice.class);
